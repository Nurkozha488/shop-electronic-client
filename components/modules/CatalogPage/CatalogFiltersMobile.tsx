...
const CatalogFiltersMobile = ({
  ...
  const handleOpenElectronics = () => setOpenElectronics(true)
  const handleCloseElectronics = () => setOpenElectronics(false)
  ...
  const resetAllElectronicManufacturers = () =>
    setElectronicManufacturers(
  ...
  return (
    ...
    >
      <div className={styles.catalog__bottom__filters__inner}>
        ...
        />
        <div className={styles.filters__electronic_manufacturers}>
          <button
            className={`${styles.filters__manufacturer__btn} ${darkModeClass}`}
            onClick={handleOpenElectronics}
          >
            Производитель
          </button>
          <FiltersPopup
            title="Производитель"
            resetFilterBtnDisabled={!isAnyElectronicManufacturerChecked}
            updateManufacturer={updateElectronicManufacturer}
            setManufacturer={setElectronicManufacturers}
            applyFilters={applyFiltersAndClosePopup}
            manufacturersList={electronicManufacturers}
            resetAllManufacturers={resetAllElectronicManufacturers}
            handleClosePopup={handleCloseElectronics}
            openPopup={openElectronics}
          />
        </div>
        <div className={styles.filters__electronic_manufacturers}>
          <button
